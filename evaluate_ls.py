...
def perform_local_search(greedy, exchange_nodes, starting_solution_name, starting_solution, distance_matrix, nodes_cost, candidate_moves):
    ...
    return greedy, exchange_nodes, starting_solution_name, solution_dict, local_search_time, candidate_moves
...
for problem, instance in data.items():
    ...
    for i in range(200):
        ...
        #! Run all of these after bug was found.
        tasks.append(delayed(perform_local_search)(False, False, 'random', starting_solutions['random'], distance_matrix, nodes_cost, True))
        tasks.append(delayed(perform_local_search)(False, False, 'greedy', starting_solutions['greedy'], distance_matrix, nodes_cost, False))
        tasks.append(delayed(perform_local_search)(False, False, 'random', starting_solutions['random'], distance_matrix, nodes_cost, False))
        tasks.append(delayed(perform_local_search)(True, False, 'random', starting_solutions['random'], distance_matrix, nodes_cost, False))
        tasks.append(delayed(perform_local_search)(True, False, 'greedy', starting_solutions['greedy'], distance_matrix, nodes_cost, False))
    ...
    for result in parallel_results:
        greedy, exchange_nodes, starting_solution_name, solution_dict, local_search_time, candidate_moves = result
